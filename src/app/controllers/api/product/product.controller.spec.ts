...
//     [ product0, product1, product2 ] = await productRepository.save([
//       {
//         owner: user1,
//         text: 'Product 0',
//       },
...
//     it('should return an HttpResponseNotFound object if the product belongs to another user.', async () => {
//       const ctx = new Context({
//         params: {
...
//       strictEqual(product.owner.id, user2.id);
...
//     it('should return an HttpResponseNotFound if the product belongs to another user.', async () => {
//       const ctx = new Context({
//         params: {
//           productId: product0.id
//         }
